    ...
    <div className="flex-1 flex items-center justify-center p-6 bg-[url('/bg-abstract.svg')] bg-cover bg-center mt-20">
      ...
      >
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-white/60 text-sm">Start validating your ideas today</p>
        </div>
        ...
        <div className="mt-8 text-center text-sm text-white/60">
          ...
          <Link to="/login" className="text-primary hover:text-orange-400 transition-colors font-medium">
            Sign in
          </Link>
        </div>
      </motion.div>
